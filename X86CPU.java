...
public class X86CPU {
    ...
    private String MarContent;                                // add mar mbr
    private String MbrContent;
    ...
    public void SingleStep(){
        int i_address = this.regPC.GetValueWithInt();            // get the address from pc
        this.regPC.SetValue(i_address + 4);                       // the next is plus 4?
        this.MbrContent = this.memory.GetContent()[i_address][1];    // is that the second is the value?
        this.MarContent = this.regPC.GetBinaryString();
    }

    public String GetMar(){
        return  this.MarContent;
    }

    public String GetMbr(){
        return  this.MbrContent;
    }
